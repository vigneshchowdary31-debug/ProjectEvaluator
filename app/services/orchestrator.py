...
class OrchestratorService:
    ...
    async def run_audit_task(self, run_id: str, project_id: str, user_id: str) -> None:
        ...
        run = self.audit_run_repo.get_by_id(run_id)
        if not run:
        ...
        if project.repository_url:
            ...
            try:
                ...
                github_response = self.github_service.analyze(GithubAnalysisRequest(repo_url=project.repository_url, force_refresh=True))
        ...
        try:
            ...
            for f in security_findings:
                ...
                self.evidence_repo.create(evidence_rec)
        ...
        try:
            ...
            gemini_wrapper = self.github_service.gemini.generate_project_reports(
                prd=prd_result,
            ...
            # Wait, let's write database insertion directly since report_gen_service has it
